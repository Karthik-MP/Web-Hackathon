  ...
  <div id="topbar" class="hoc clear"> 
   <div class="fl_left">
    ...
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="welcome.php?q=1" style="margin-left: 160px;"><b>Gitam Quiz System</b></a>
        </div>
                ...
                <?php
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            $e=$row['email'];
                            $s=$row['score'];
                            $q12=mysqli_query($con,"SELECT * FROM rank WHERE email='$e' " )or die('Error231');
